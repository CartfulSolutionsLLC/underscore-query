...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/json-query.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _query_builder__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./query-builder */ "./src/query-builder.js");
...
var lookup = function lookup(keysArr, obj) {
  ...
  for (var idx in keysArr) {
    ...
    if (Object(lodash__WEBPACK_IMPORTED_MODULE_18__["isArray"])(out)) {
      remainingKeys = keysArr.slice(idx);
      out = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["map"])(out, function (v) {
        return lookup(remainingKeys, v);
      });
    } else if (out) {
      out = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["result"])(out, key);
    } else {
      break;
    }
  }
...
var multipleConditions = function multipleConditions(key, queries) {
  return Object.keys(queries || {}).map(function (type) {
    return _utils__WEBPACK_IMPORTED_MODULE_19__["makeObj"](key, _utils__WEBPACK_IMPORTED_MODULE_19__["makeObj"](type, queries[type]));
  });
};

var parseParamType = function parseParamType(query) {
  var resultArr = [];
  ...
  for (var key in query) {
    ...
    if (key.indexOf('.') !== -1) {
      o.getter = _utils__WEBPACK_IMPORTED_MODULE_19__["makeGetter"](lookup)(key);
    }

    var paramType = _utils__WEBPACK_IMPORTED_MODULE_19__["getType"](queryParam);
    var size = void 0;
    ...
    switch (paramType) {
      ...
      case 'Array':
        if (Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(_utils__WEBPACK_IMPORTED_MODULE_19__["compoundKeys"], key)) {
          o.type = key;
      ...
      case 'Object':
        size = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["keys"])(queryParam).length;
          ...
          for (var type in queryParam) {
            ...
            if (testQueryValue(type, value)) {
              ...
              switch (type) {
                ...
                case '$endsWith':
                  o.value = _utils__WEBPACK_IMPORTED_MODULE_19__["reverseString"](value);
                  break;
                ...
                case '$or':
                case '$and':
                  o.value = parseSubQuery(_utils__WEBPACK_IMPORTED_MODULE_19__["makeObj"](o.key, value));
                  o.key = null;
                  break;

                case '$computed':
                  o = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["first"])(parseParamType(_utils__WEBPACK_IMPORTED_MODULE_19__["makeObj"](key, value)));
                  o.getter = _utils__WEBPACK_IMPORTED_MODULE_19__["makeGetter"](lookup)(key);
                  break;
    ...
    if (o.type === '$equal' && Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(['Object', 'Array'], paramType)) {
      o.type = '$deepEqual';
    } else if (Object(lodash__WEBPACK_IMPORTED_MODULE_18__["isNaN"])(o.value)) {
      o.type = '$deepEqual';
    }
...
var parseSubQuery = function parseSubQuery(rawQuery, type) {
  var queryArray;

  if (Object(lodash__WEBPACK_IMPORTED_MODULE_18__["isArray"])(rawQuery)) {
    queryArray = rawQuery;
  } else {
    queryArray = Object.keys(rawQuery).filter(function (key) {
      return Object.prototype.hasOwnProperty.call(rawQuery, key);
    }).map(function (key) {
      return _utils__WEBPACK_IMPORTED_MODULE_19__["makeObj"](key, rawQuery[key]);
    });
  }

  var iteratee = function iteratee(memo, query) {
    var parsed = parseParamType(query);
  ...
  var resultArr = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["reduce"])(queryArray, iteratee, []);
  return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["sortBy"])(resultArr, function (x) {
    var index = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["indexOf"])(_utils__WEBPACK_IMPORTED_MODULE_19__["tagSortOrder"], x.type);
...
var testQueryValue = function testQueryValue(queryType, value) {
  var valueType = _utils__WEBPACK_IMPORTED_MODULE_19__["getType"](value);
  ...
  switch (queryType) {
    ...
    case '$regex':
    case '$regexp':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(['RegExp', 'String'], valueType);
...
var testModelAttribute = function testModelAttribute(queryType, value) {
  var valueType = _utils__WEBPACK_IMPORTED_MODULE_19__["getType"](value);
  ...
  switch (queryType) {
    ...
    case '$size':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(['String', 'Array'], valueType);
...
var performQuery = function performQuery(type, value, attr, model, getter) {
  switch (type) {
    case '$and':
    case '$or':
    case '$nor':
  ...
  switch (type) {
    case '$equal':
      if (Object(lodash__WEBPACK_IMPORTED_MODULE_18__["isArray"])(attr)) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(attr, value);
      }

      return attr === value;

    case '$deepEqual':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["isEqual"])(attr, value);

    case '$ne':
      return attr !== value;

    case '$type':
      return _typeof(attr) === value;
    ...
    case '$in':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(value, attr);

    case '$nin':
      return !Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(value, attr);

    case '$all':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["every"])(value, function (item) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(attr, item);
      });

    case '$any':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["some"])(attr, function (item) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(value, item);
      });
    ...
    case '$endsWith':
      return _utils__WEBPACK_IMPORTED_MODULE_19__["reverseString"](attr).indexOf(value) === 0;
...
var single = function single(queries, getter, isScore) {
  var queryObj;
  ...
  if (isScore) {
    ...
    return function (model) {
      return Object.assign(model, {
        _score: performQuerySingle(queryObj.type, queryObj.parsedQuery, getter, model, true)
      });
    };
  } else {
    return function (model) {
      return (queries || []).every(function (queryObj) {
        return performQuerySingle(queryObj.type, queryObj.parsedQuery, getter, model, isScore);
      });
    };
  }
};

var performQuerySingle = function performQuerySingle(type, query, getter, model, isScore) {
  var scoreInc = 1 / query.length;
  var passes = 0;
  var score = 0;
  var attr;
  var test;
...
var parseQuery = function parseQuery(query) {
  var queryKeys = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["keys"])(query);

  if (!queryKeys.length) {
    return [];
  }

  var compoundQuery = Object(lodash__WEBPACK_IMPORTED_MODULE_18__["intersection"])(_utils__WEBPACK_IMPORTED_MODULE_19__["compoundKeys"], queryKeys);
  var _iteratorNormalCompletion2 = true;
  var _didIteratorError2 = false;
  var _iteratorError2 = undefined;

  try {
    for (var _iterator2 = compoundQuery[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var type = _step2.value;

      if (!Object(lodash__WEBPACK_IMPORTED_MODULE_18__["isArray"])(query[type]) && Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(_utils__WEBPACK_IMPORTED_MODULE_19__["expectedArrayQueries"], type)) {
  ...
  if (compoundQuery.length === 0) {
    ...
    if (!Object(lodash__WEBPACK_IMPORTED_MODULE_18__["includes"])(compoundQuery, '$and')) {
      query.$and = {};
  ...
  return (compoundQuery || []).map(function (type) {
    return {
      type: type,
...
var parseGetter = function parseGetter(getter) {
...
var buildQuery = function buildQuery(items, getter) {
  return new _query_builder__WEBPACK_IMPORTED_MODULE_20__["QueryBuilder"](items, getter, runQuery, makeTest);
};

var makeTest = function makeTest(query, getter) {
  return single(parseQuery(query), parseGetter(getter));
};

var findOne = function findOne(items, query, getter) {
  return runQuery(items, query, getter, true);
};

var score = function score(items, query, getter) {
  return runQuery(items, query, getter, false, true);
};

var runQuery = function runQuery(items, query, getter, first, isScore) {
  var fn;
  ...
  if (!(_utils__WEBPACK_IMPORTED_MODULE_19__["getType"](query) === 'Function')) {
    query = single(parseQuery(query), getter, isScore);
  }

  if (isScore) {
    fn = lodash__WEBPACK_IMPORTED_MODULE_18__["map"];
  } else if (first) {
    fn = lodash__WEBPACK_IMPORTED_MODULE_18__["find"];
  } else {
    fn = lodash__WEBPACK_IMPORTED_MODULE_18__["filter"];
  }
...
runQuery.getter = runQuery.pluckWith = _utils__WEBPACK_IMPORTED_MODULE_19__["makeGetter"](lookup);
...
var QueryBuilder = /*#__PURE__*/function () {
  function QueryBuilder(items, _getter, runQuery, makeTest) {
  ...
  _createClass(QueryBuilder, [{
    key: "all",
    value: function all(items, first) {
      if (items) {
        this.items = items;
      } else {
        items = this.items;
    ...
    value: function chain() {
      return Object(lodash__WEBPACK_IMPORTED_MODULE_8__["chain"])(this.all.apply(this, arguments));
    }
  }, {
    key: "tester",
...
var addToQuery = function addToQuery(type) {
  return function (params, qVal) {
    if (qVal) {
      params = _utils__WEBPACK_IMPORTED_MODULE_9__["makeObj"](params, qVal);
    }
...
try {
  for (var _iterator = _utils__WEBPACK_IMPORTED_MODULE_9__["compoundKeys"][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var key = _step.value;
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: compoundKeys, expectedArrayQueries, tagSortOrder, getType, makeObj, reverseString, makeGetter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "compoundKeys", function() { return compoundKeys; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "expectedArrayQueries", function() { return expectedArrayQueries; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tagSortOrder", function() { return tagSortOrder; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getType", function() { return getType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeObj", function() { return makeObj; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reverseString", function() { return reverseString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeGetter", function() { return makeGetter; });
...
var expectedArrayQueries = ['$and', '$or', '$nor'];
var tagSortOrder = ['$lt', '$lte', '$gt', '$gte', '$exists', '$has', '$type', '$ne', '$equal', '$mod', '$size', '$between', '$betweene', '$startsWith', '$endsWith', '$like', '$likeI', '$contains', '$in', '$nin', '$all', '$any', '$none', '$cb', '$regex', '$regexp', '$deepEqual', '$elemMatch', '$not', '$and', '$or', '$nor'];
var getType = function getType(obj) {
  var type = Object.prototype.toString.call(obj).substr(8);
  return type.substr(0, type.length - 1);
};
var makeObj = function makeObj(key, val) {
  return _defineProperty({}, key, val);
};
var reverseString = function reverseString(str) {
  return str.toLowerCase().split('').reverse().join('');
};
var makeGetter = function makeGetter(lookup) {
